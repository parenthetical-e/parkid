---
title: "Exp analysis - exp68 and 69 (and 38) - BanditBigMonster10"
...
img_path <- "~/Code/parkid/analysis/img/exp68-69/"
dir.create(img_path)
```
...
exp_names <- c("exp28", "exp68", "exp69")
agent_names <- c("ParKid", "ParKid-4", "ParPar")
file_names <-
  c(
    "par_action",
    "par_policy",
