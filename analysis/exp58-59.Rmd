---
title: "Exp analysis - exp58 and 59 (and 38) - BanditBigMonster10"
...
img_path <- "~/Code/parkid/analysis/img/exp58-59/"
dir.create(img_path)
```
...
exp_names <- c("exp28", "exp58", "exp59")
agent_names <- c("ParKid", "ParKid-2", "ParPar")
file_names <-
  c(
    "par_action",
    "par_policy",
