---
title: "Exp analysis - exp70 and 71 - BanditStaticRegMonster"
...
img_path <- "~/Code/parkid/analysis/img/exp70-71/"
dir.create(img_path)
```
...
exp_names <- c("exp20", "exp34", "exp70", "exp71")
agent_names <- c("ParKid", "ParKid-01", "ParKid-4", "ParPar")
file_names <-
  c(
    "par_action",
    "par_policy",
