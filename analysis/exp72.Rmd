---
title: "Exp analysis - exp72 (and others) - an oracle on BanditStaticRegMonster"
...
img_path <- "~/Code/parkid/analysis/img/exp72/"
dir.create(img_path)
```
...
exp_names <- c("exp20", "exp70", "exp71", "exp72")
agent_names <- c("ParKid", "ParKid-4", "ParPar", "Oracle")
file_names <-
  c(
    "par_action",
    "par_policy",
