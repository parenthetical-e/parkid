---
title: "Exp analysis - exp75 (and others) - a random on BanditStaticRegMonster"
...
img_path <- "~/Code/parkid/analysis/img/exp75/"
dir.create(img_path)
```
...
exp_names <- c("exp75", "exp20", "exp34", "exp70", "exp71", "exp72")
agent_names <- c("Random", "ParKid", "ParKid-01", "ParKid-4", "ParPar", "Oracle")
file_names <-
  c(
    "par_action",
    "par_policy",
